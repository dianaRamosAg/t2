...
const csvFilePath='C:\\Users\\Jaquelin Ramos A\\Desktop\\Diana\\ae2019vu3eje01-master\\usuarios.csv'
const csv=require('csvtojson');

const csvUsuarios = (req, res) => {
     csv()
    ...
    .then((jsonObj)=>{
        ...
        .then((jsonObj)=> {
            res.json({msg:"Se han creado todos los usuarios", jsonObj: jsonObj});}
        )
        .catch((err)=> {
            res.status(status.BAD_REQUEST);
            res.json({msg:"Error", data:err});
